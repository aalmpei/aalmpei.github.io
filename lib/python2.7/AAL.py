...
class Matrix(_object):
    ...
    def SolveLinearEquationSystem(self, *args):
        """SolveLinearEquationSystem(Matrix self, Matrix A, Polynom const & right) -> Polynom"""
...
class TWord(_object):
    """Proxy of C++ AAL::TWord class"""
    __swig_setmethods__ = {}
    __setattr__ = lambda self, name, value: _swig_setattr(self, TWord, name, value)
    __swig_getmethods__ = {}
    __getattr__ = lambda self, name: _swig_getattr(self, TWord, name)
    __repr__ = _swig_repr
    def __init__(self): 
        """__init__(AAL::TWord self) -> TWord"""
        this = _AAL.new_TWord()
        try: self.this.append(this)
        except: self.this = this
    __swig_destroy__ = _AAL.delete_TWord
    __del__ = lambda self : None;
TWord_swigregister = _AAL.TWord_swigregister
TWord_swigregister(TWord)

BackHex = _AAL.BackHex
BackBin = _AAL.BackBin
BackDec = _AAL.BackDec
class Polynom(uintBasicType):
    ...
    def TAB():
        """TAB() -> unsigned int *"""
        return _AAL.Polynom_TAB()

    if _newclass:TAB = staticmethod(TAB)
    __swig_getmethods__["TAB"] = lambda x: TAB
    def Pos():
        """Pos() -> unsigned int **"""
        return _AAL.Polynom_Pos()

    if _newclass:Pos = staticmethod(Pos)
    __swig_getmethods__["Pos"] = lambda x: Pos
    def GenerateTab():
        """GenerateTab() -> unsigned int *"""
        return _AAL.Polynom_GenerateTab()

    if _newclass:GenerateTab = staticmethod(GenerateTab)
    __swig_getmethods__["GenerateTab"] = lambda x: GenerateTab
    def GeneratePos():
        """GeneratePos() -> unsigned int **"""
        return _AAL.Polynom_GeneratePos()

    if _newclass:GeneratePos = staticmethod(GeneratePos)
    __swig_getmethods__["GeneratePos"] = lambda x: GeneratePos
    def __init__(self, *args): 
        """
    ...
    def tostring(self):
        """tostring(Polynom self) -> std::string"""
        return _AAL.Polynom_tostring(self)
    ...
    def setPolynom(self, *args):
        """setPolynom(Polynom self, AAL::uint arg2) -> Polynom"""
    ...
    def isPolynom(self, *args):
        """isPolynom(Polynom self, AAL::uint polynom) -> bool"""
    ...
    def WordByWord(*args):
        """WordByWord(TWord a, TWord b, int n) -> TWord"""
        return _AAL.Polynom_WordByWord(*args)

    if _newclass:WordByWord = staticmethod(WordByWord)
    __swig_getmethods__["WordByWord"] = lambda x: WordByWord
    def Lop16(self, *args):
        """Lop16(Polynom self, TWord a, TWord b) -> TWord"""
        return _AAL.Polynom_Lop16(self, *args)

    def Lop32(self, *args):
        """Lop32(Polynom self, TWord a, TWord b) -> TWord"""
        return _AAL.Polynom_Lop32(self, *args)

    def MulElemPolynoms(self, *args):
        """MulElemPolynoms(Polynom self, AAL::uchar u, AAL::uchar v) -> AAL::ushort"""
        return _AAL.Polynom_MulElemPolynoms(self, *args)
    ...
    def Impl(self, *args):
        """Impl(Polynom self, Polynom a, Polynom b) -> Polynom"""
        return _AAL.Polynom_Impl(self, *args)
...
def Polynom_TAB():
  """Polynom_TAB() -> unsigned int *"""
  return _AAL.Polynom_TAB()

def Polynom_Pos():
  """Polynom_Pos() -> unsigned int **"""
  return _AAL.Polynom_Pos()

def Polynom_GenerateTab():
  """Polynom_GenerateTab() -> unsigned int *"""
  return _AAL.Polynom_GenerateTab()

def Polynom_GeneratePos():
  """Polynom_GeneratePos() -> unsigned int **"""
  return _AAL.Polynom_GeneratePos()

def Polynom_WordByWord(*args):
  """Polynom_WordByWord(TWord a, TWord b, int n) -> TWord"""
  return _AAL.Polynom_WordByWord(*args)
